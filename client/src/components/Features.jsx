            ...
            <div className="flex flex-col  md:flex-row gap-6">
              <div className=" text-center ">
                ...
                <p className="mt-5 text-[#595959] ">
                  Easy and simple way to track daily expenses and income. The
                  main screen shows a calendar with a clear monthly view of all
                  transactions.
                </p>
              </div>
              ...
              <div className=" text-center ">
                ...
                <p className="mt-5 text-[#595959]  ">
                  Your data is always safe, no matter where you are or what
                  device you use.
                </p>
              </div>
              ...
              <div className=" text-center ">
                ...
                <p className="mt-5 text-[#595959]  ">
                  A simple but complete list of expense and income categories.
                  You can add or edit categories if needed
                </p>
              </div>
